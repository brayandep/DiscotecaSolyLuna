...
@section('subtitle', 'Modifica la información, precio, acompañamiento e imagen del producto.')
...
<div class="card product-card">
    <div class="product-header">
        ...
        <div>
            ...
            <p>Actualiza los datos del producto seleccionado.</p>
        </div>
    </div>

    <div class="warning-edit">
        Solo la dueña o usuario SuperAdmin puede editar productos.
    </div>

    <div class="gold-line"></div>

    <form class="product-form" action="{{ route('productos.update', $producto) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="form-grid">
            ...
            <div>
                ...
                <select name="categoria" required>
                    ...
                    @foreach(['Cerveza', 'Licor', 'Energizante', 'Gaseosa', 'Agua', 'Snack', 'Promoción', 'Insumo', 'Otro'] as $categoria)
            ...
            <div>
                ...
                <input
                    ...
                    required
                >
                <div class="help">Precio base del producto.</div>
            </div>
            ...
            <div>
                ...
                <input
                    ...
                    value="{{ old('nombre_acompanamiento', $producto->nombre_acompanamiento) }}"
                    placeholder="Ejemplo: Hielo, energizante, vaso especial"
                >
                <div class="help">Opcional. Déjalo vacío si no aplica.</div>
            </div>

            <div>
                <label class="field-label">
                    <span class="icon">Bs</span>
                    Precio adicional del acompañamiento
                </label>
                <input
                    class="input"
                    type="number"
                    ...
                    value="{{ old('precio_acompanamiento', $producto->precio_acompanamiento ?? 0) }}"
                    min="0"
                >
                <div class="help">Ejemplo: producto Bs 20 + hielo Bs 20 = Bs 40.</div>
            </div>
                ...
                <label class="status-box" for="estado">
                    ...
                    <div>
                        ...
                        <div class="status-text">
                            Si está activo, se podrá vender desde el sistema.
                        </div>
                    </div>
                </label>
            </div>
            ...
            <div>
                ...
                <div class="photo-area">
                    <div class="preview-box" id="previewBox">
                        @if($producto->imagen)
                            <img id="previewImage" src="{{ asset('storage/' . $producto->imagen) }}" alt="Vista previa">
                    ...
                    <div>
                        ...
                        <div class="help">
                            Si seleccionas una nueva imagen, reemplazará la anterior.<br>
